...
I have choosing the DogWalker component as my design for the main reason that I can think of multiple ways to represent the data is this one but that is much for diffucult for the other two. Representing the data in multiple ways seems to fit with the rest of the OSU compnents. Also, the methods for this class fit with the Kernal and secondary structure quite well.
